document.addEventListener('DOMContentLoaded', function () {
    ...
    registerForm.addEventListener('submit', function (e) {
        ...
        // 2. Kiểm tra biểu thức chính quy (Regex) cho Email và Mật khẩu
        ...
        // 4. Lấy danh sách tài khoản hiện có từ LocalStorage
        const listUser = JSON.parse(localStorage.getItem('listUser')) || [];

        // 5. Kiểm tra xem email này đã có ai đăng ký chưa
        ...
        // 6. Thêm tài khoản mới vào danh sách
        listUser.push({
            email: email,
            password: password
        });
        ...
        // 8. Chuyển hướng sang trang đăng nhập
